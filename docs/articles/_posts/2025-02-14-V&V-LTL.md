...
Consideriamo la formula <b>"p è vero in uno degli ultimi n istanti".</b>

Formalmente, in LTL+P possiamo scriverla in modo molto compatto:
$\bigvee_{i=0}^{n−1} Y_i p$
...
In LTL senza passato, non possiamo fare riferimento direttamente al passato, quindi dobbiamo riformulare la condizione usando il futuro.
Possiamo esprimere la stessa proprietà dicendo:
