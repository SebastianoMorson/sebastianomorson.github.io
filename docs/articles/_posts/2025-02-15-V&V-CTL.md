---
layout: post
title: V&V-Computational Tree Logic (CTL)
...
- $M,s_0 \vDash  Ep \iff \exists x = (s_0, \dots) (M,s_0 \vDash p)$

- $M,s_0 \vDash  Ap \iff \forall x = (s_0, \dots) (M,s_0 \vDash p)$
...
- $M,x \vDash p\land q \iff M,x \vDash p \land M,s_0 \vDash q$
- $M,x \vDash p\lor q \iff M,x \vDash p \lor M,s_0 \vDash q$
